...
#define MAX_PACKET_SIZE 2048 /* TCP DNS also has to support */
...
#ifndef DNS_TIMEOUT 
#ifdef SKY
#define DNS_TIMEOUT 10 /* changed to 10 seconds from 240 as per Sky requirement*/
#else
...
#else // SKY
#define DHCP_LEASES_DEFAULT "/etc/udhcpd.leases" // "/var/auxfs/udhcpd.leases"
#endif // SKY
#endif
